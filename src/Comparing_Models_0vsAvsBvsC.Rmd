...
```{r}
auc(ifelse(Aug_med_0vsAvsBvsC.sum.7.2.test$Result_2016 == 'C', 1, 0), Aug_med.0vsAvsBvsC.pred.rf[,4])
```

```{r}
coords(Aug_med.0vsAvsBvsC.mroc.rf, .4, "threshold", ret=c("sensitivity","specificity","ppv","npv"))
```
...
```{r}
auc(ifelse(Aug_med_0vsAvsBvsC.sum.7.2.test$Result_2016 == 'C', 1, 0),
    ifelse(Aug_med.0vsAvsBvsC.test.pred.xgb == 3, 1, 0))
```

```{r}
coords(Aug_med.0vsAvsBvsC.mroc.xgb, .4, "threshold", ret=c("sensitivity","specificity","ppv","npv"))
```
